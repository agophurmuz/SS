...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        List<Body> planets = parser.parseFile("/Users/agophurmuz/Documents/ITBA/SS/TP4/src/itba/edu/ar/utils/data/year/","month-",3,3);

        BeemanVoyager voyager = new BeemanVoyager(126144000, 60, new Body(0,0,
                new Position(0,0), 721, BodyType.VOYAGER), planets);
        voyager.move();

        //BeemanNoPredicted beemanNoPredicted = new BeemanNoPredicted(k, gama, r0, v0, mass, totalTime, deltaTime);
        //beemanNoPredicted.oscillate();
    }
}
