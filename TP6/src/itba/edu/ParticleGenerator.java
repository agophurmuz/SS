...
public class ParticleGenerator {
    ...
    public static List<Particle> generateParticles(double massParticle, double minDiameter,
                                                   double maxDiameter, double L, double W, double desiredV) {
        return generateParticles(massParticle, minDiameter, maxDiameter, L, W, desiredV, MAX_PARTICLES);
    }

    public static List<Particle> generateParticles(double massParticle, double minDiameter,
                                            double maxDiameter, double L, double W, double desiredV, Integer particleAmount) {
        ...
        particles.add(new Particle(0, new Position(x1, y1), vx1, vy1, r, massParticle, desiredV));
        ...
        for (int i = 1; flag && particles.size() < particleAmount; i++) {
            ...
            if (flag){
                particles.add(new Particle(i, new Position(x2, y2), 0, 0, r2, massParticle, desiredV));
            }
        }
        return particles;
    }
